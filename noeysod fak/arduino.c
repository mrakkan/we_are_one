...
const char PUBLISH_TOPIC[] = "66070286/temp";    // CHANGE IT AS YOU DESIRE
const char SUBSCRIBE_TOPIC[] = "66070286/temp";  // CHANGE IT AS YOU DESIRE
...
// ^ 2 อ่านค่าจาก ตัวต้านทานปรับค่าได้ แล้วแสดงค่า (0-1023)


// ^ 3 อ่านค่าระยะทางจาก Ultrasonic หน่วยเป็น cm
...
const char MQTT_BROKER_ADRRESS[] = "mqtt-dashboard.com";  // CHANGE TO MQTT BROKER'S ADDRESS
const int MQTT_PORT = 1883;
const char MQTT_CLIENT_ID[] = "66070228";  // CHANGE IT AS YOU DESIRE
const char MQTT_USERNAME[] = "";                                            // CHANGE IT IF REQUIRED, empty if not required
const char MQTT_PASSWORD[] = "";                                            // CHANGE IT IF REQUIRED, empty if not required

// The MQTT topics that Arduino should publish/subscribe
const char PUBLISH_TOPIC[] = "66070286/food";    // CHANGE IT AS YOU DESIRE
const char SUBSCRIBE_TOPIC[] = "66070286/food";  // CHANGE IT AS YOU DESIRE

const int PUBLISH_INTERVAL = 5000;  // 60 seconds
